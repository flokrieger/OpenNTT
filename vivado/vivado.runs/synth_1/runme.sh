...
HD_PWD='/home/fkrieger/Documents/openNTT/vivado/vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OpenNTT_BD_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OpenNTT_BD_wrapper.tcl
