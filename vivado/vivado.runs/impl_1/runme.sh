...
HD_PWD='/home/fkrieger/Documents/openNTT/vivado/vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OpenNTT_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OpenNTT_BD_wrapper.tcl -notrace
