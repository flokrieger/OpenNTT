...
HD_PWD='/home/fkrieger/Desktop/openNTT/vivado/vivado.runs/OpenNTT_BD_axi_cdma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OpenNTT_BD_axi_cdma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OpenNTT_BD_axi_cdma_0_0.tcl
