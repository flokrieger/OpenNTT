...
// Parametric twiddle factor generation for DIF RN NTT
module TwiddleGen_DIF_RN #(
  ...
  localparam string rom_filename = $sformatf("%s/tool/RomContent/twiddle_mem_DIF_RN_n%0d_pe%0d_lat%0d_MontRed_0.mem", `OPEN_NTT_PATH, 1<<LOGN, PE, MODMUL_LAT_CEIL);
