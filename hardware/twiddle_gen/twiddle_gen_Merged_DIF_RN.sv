...
// Parametric twiddle factor generation for MemOpt merged DIF RN transformations
module TwiddleGen_Merged_DIF_RN 
  ...
  localparam string rom_filename = NTT ? $sformatf("%s/tool/RomContent/twiddle_mem_Merged_DIF_RN_n%0d_pe%0d_lat%0d_MontRed_0.mem", open_ntt_pkg::OPEN_NTT_PATH, 1<<LOGN, PE, MODMUL_LAT_CEIL):
                                         $sformatf("%s/tool/RomContent/twiddle_mem_Merged_DIF_RN_n%0d_pe%0d_lat%0d_FFT_0.mem",     open_ntt_pkg::OPEN_NTT_PATH, 1<<LOGN, PE, MODMUL_LAT_CEIL);
