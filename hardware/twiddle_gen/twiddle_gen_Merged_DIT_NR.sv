...
// Parametric twiddle factor generation for Merged DIT NR NTT
module TwiddleGen_Merged_DIT_NR #(
  ...
  localparam string rom_filename = $sformatf("%s/tool/RomContent/twiddle_mem_Merged_DIT_NR_n%0d_pe%0d_lat%0d_MontRed_0.mem", `OPEN_NTT_PATH, 1<<LOGN, PE, MODMUL_LAT_CEIL);
